...
Experiment = 3 % Select data. 1 = Experiment full speed, 2= Hoisting, 3 = Lowering, 4 = Hoisting and Lowering Experiment
...
VFD_acceleration_model_factor   = 0.27;     % n/M in Starter (inertia = 2.53kgm2)
